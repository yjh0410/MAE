...
def build_vit(args):
    ...
    if args.model == 'vit_nano':
        model = vit_nano(args.img_size, args.patch_size, args.img_dim, args.num_classes, args.learnable_pos)
    elif args.model == 'vit_tiny':
        model = vit_tiny(args.img_size, args.patch_size, args.img_dim, args.num_classes, args.learnable_pos)
    elif args.model == 'vit_base':
        model = vit_base(args.img_size, args.patch_size, args.img_dim, args.num_classes, args.learnable_pos)
    elif args.model == 'vit_large':
        model = vit_large(args.img_size, args.patch_size, args.img_dim, args.num_classes, args.learnable_pos)
    elif args.model == 'vit_huge':
        model = vit_huge(args.img_size, args.patch_size, args.img_dim, args.num_classes, args.learnable_pos)
